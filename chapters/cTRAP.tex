...
The ranked list from \texttt{rankSimilarPerturbations()} can be plotted using \texttt{plot()}, showing a list of all results ordered by a given score or either a scatterplot or GSEA plot of the results against a single CMap perturbation (examples shown in \fullref{subsec:case-study}).
